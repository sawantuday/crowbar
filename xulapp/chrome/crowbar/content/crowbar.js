    ...
    onSocketAccepted: function(serv, transport) {
        ...
        var dataListener = {
            ...
            onDataAvailable: function(request, context, inputStream, offset, count) {
                ...
                if (this.data.match(/[\n\r]{2}/)) {
                    // TODO(SM): these string fragments are horrible, we should think of using a sort of template system
                                ...
                                if (params.mode == "links") {
                                    ...
                                    var process = function() {
                                        ...
                                        if (scraper && scraper.match(/^http\:\/\/.*$/)) {
                                            //
                                            // TODO(SM): This is where Crowbar should be able to execute PiggyBank/Solvent scrapers 
                                            // and return the serialized RDF. The easiest way would be for Crowbar to depend on 
                                            // Piggy Bank (just like Solvent does) and use the same machinery.
                                            // The alternative is to rewrite the Piggy Bank scraper invocation machinery here 
                                            // and simulate the "model" (which in piggy bank is a java object) as a javascript one
                                            //
                                        } else {
                                            code = "400";
                                            mime_type = "text/html";
                                    ...
                                    var process = function() {
                                        ...
                                        var mime_type = "application/rdf+xml";
                                        //
                                        // TODO(SM): here we should find a way to ask the javascript environment 
                                        // that is loaded in the page for the Exhibit object and call its exporters
                                        //
                                        return [ code, mime_type, page ];
                                    };
                                } else {
